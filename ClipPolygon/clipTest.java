...
public class clipTest implements KeyListener {
    ...
    clipTest()
    {
        ...
        float quax[] = new float[3];
        float quay[] = new float[3];
        quax[0] = 25.0f; quay[0] = 125.0f;
        quax[1] = 75.0f; quay[1] = 125.0f;
        quax[2] = 50.0f; quay[2] = 175.0f;
    ...
    //    drawClipRegion(  30,  10,  70,  80 );
      //  drawClipRegion(  90,  34, 120,  60 );
        ...
        wl = 0;
        wl = C.clipPolygon(8,x,y,wx,wy,35,35,165,175);
     ...
     /*   wl = 0;
       ...
       ///
        ...
        wl = 0;
        System.out.println("in cliptest");
        wl = C.clipPolygon( 5, pent1x, pent1y, wx, wy, 90, 34, 120, 60 );
        System.out.println("out cliptest");
