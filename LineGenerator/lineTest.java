package Hw1;/*<applet code=applet.java width=600 height=600>
</applet>*/
//
//  Hw1.lineTest.java
//
...
//         \______|  \______/
        ...
        R.drawLine( 520, 340, 540, 360, S );  // 45 degree slope - 135
        R.drawLine( 540, 360, 560, 450, S );  // 77.47 degree slope -- Dint print
        R.drawLine( 560, 450, 540, 540, S );  // 102.83 degree slope -- Dint print
        ...
        R.drawLine( 360, 540, 340, 450, S ); //--Dit pritn
        R.drawLine( 340, 450, 360, 360, S );//--Dit pritn
       ...
       // Letter N
        //Vertical line
        R.drawLine(40,250,40,40,S); //first 2 lines of N
        R.drawLine(90,210,90,40,S);

        R.drawLine(250,250,250,40,S);//Second 2 lines of N
        R.drawLine(200,250,200,90,S);

         //Horizontal Lines
        R.drawLine(40,250,120,250,S); //1st top line
        R.drawLine(40,40,90,40,S);
        R.drawLine(170,40,250,40,S);
        R.drawLine(200,250,250,250,S);
        R.drawLine(375,50,525,50,S);
        R.drawLine(375,90,485,90,S);

        //Slant Lines
        R.drawLine(200,90,120,250,S);
        R.drawLine(90,210,170,40,S);


        //Letter S
        R.drawLine(350,60,375,50,S);
        R.drawLine(375,90,350,80,S);

        R.drawLine(350,80,350,60,S);
        R.drawLine(550,70,525,50,S);

        R.drawLine(550,150,550,70,S);

        R.drawLine(485,90,510,110,S);
        R.drawLine(485,130,510,110,S);

        R.drawLine(375,130,485,130,S);
        R.drawLine(410,170,525,170,S);
        R.drawLine(350,140,350,240,S);
        R.drawLine(350,240,375,250,S);
        R.drawLine(525,250,550,240,S);
        R.drawLine(550,220,525,210,S);

        R.drawLine(525,170,550,150,S);
        R.drawLine(525,210,410,210,S);
        R.drawLine(375,250,525,250,S);

        R.drawLine(550,220,550,240,S);
        R.drawLine(375,130,350,140,S);

        R.drawLine(390,190,410,210,S);
        R.drawLine(390,190,410,170,S);
